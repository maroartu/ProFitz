...
?>
    ...
    <!-- Tabs -->
    <ul class="tabs tabs-fixed-width tab-demo z-depth-1 tabs-bicicleta" style="margin-top: 65px;">
        <li class="tab"><a href="#test1" class="white-text">Montaña</a></li>
        <li class="tab"><a href="#test2" class="white-text">Electrico</a></li>
        <li class="tab"><a href="#test3" class="white-text">Ciudad</a></li>
        <li class="tab"><a href="#test4" class="white-text">Niños</a></li>
    </ul>

    <!-- Tipo de producto bicicleta-->
    <div id="test1" class="col s12">

        <!-- Producto en un tipo de bicicleta -->
