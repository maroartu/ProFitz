...
<body>
    ...
    <header>
        ...
        <ul id="dropdown-más-perfil" class="dropdown-content blue-grey darken-4">
            <li><a href="../../views/commerce/pagina_iniciar_sesion.php">Account</a></li>
            <li class="divider"></li>
            <li><a href="../../views/commerce/pagina_pedidos.php">Your orders</a></li>
        </ul>
        ...
        <div class="navbar-fixed">
            <nav>
                <div class="nav-wrapper navbar-principal">
                    <!-- Logo -->
                    <a href="../../views/commerce/index.php" class="brand-logo tooltipped center hide-on-med-and-down primario" data-position="bottom" data-tooltip="Homepage"><img src="../../resources/img/logos_tienda/logo_completo_blanco.png" alt="Logo"></a>
                    <a href="../../views/commerce/index.php" class="brand-logo center show-on-small-only hide-on-med-and-up secundario-pequeño" data-position="bottom" data-tooltip="Homepage"><img src="../../resources/img/logos_tienda/logo_mini_blanco.png" alt="Logo"></a>
                    <a href="../../views/commerce/index.php" class="brand-logo center show-on-medium hide-on-small-only hide-on-large-only secundario-mediano" data-position="bottom" data-tooltip="Homepage"><img src="../../resources/img/logos_tienda/logo_mini_blanco.png" alt="Logo"></a>
                    <!-- Sección izquierda Menú -->
                    <ul id="nav-mobile" class="left hide-on-med-and-down">
                        <li><a href="../../views/commerce/pagina_bicicleta.php">Bycicle</a></li>
                        <li><a href="../../views/commerce/pagina_eliptica.php">Elliptical</a></li>
                        <li><a href="../../views/commerce/pagina_mini_gym.php">Mini Gym</a></li>
                        <li><a href="../../views/commerce/pagina_caminadora.php">Treadmill</a></li>
                    </ul>

                    <!-- Sección derecha -->
                    <ul class="right hide-on-small-only">
                        <li><a class="tooltipped" data-position="bottom" data-tooltip="Shopping cart" href="../../views/commerce/carrito_compra.php"><i
                                    class="material-icons">shopping_cart</i></a></li>
                        <li><a class="dropdown-trigger tooltipped" data-position="bottom" data-tooltip="More" href="" data-target="dropdown-más-perfil"><i class="material-icons">account_circle
                                    keyboard_arrow_down</i></a></li>
                    </ul>

                    <!-- Icono ayuda small size -->
                    <ul class="right">
                        <li><a class="btn-floating btn-med waves-effect waves-light hide-on-med-and-up pequeño-ayuda"><i class="material-icons">help</i></a></li>
                    </ul>
                ...
                <!-- Navbar buscar-->
                <div class="nav-wrapper tooltipped navbar-buscar" data-position="bottom" data-tooltip="Search">
                    <form>
        ...
        <ul id="slide-out" class="sidenav sidenav-pequeño">
            ...
            <li><a href="#!"><i class="material-icons">airport_shuttle</i>Your orders</a></li>
            <li>
                <div class="divider grey darken-3"></div>
            </li>
            <li><a class="subheader">Menu</a></li>
            <li><a class="waves-effect" href="../../views/commerce/pagina_bicicleta.php">Byclycle</a></li>
            <li><a class="waves-effect" href="../../views/commerce/pagina_eliptica.php">Elliptical</a></li>
            <li><a class="waves-effect" href="../../views/commerce/pagina_mini_gym.php">Mini Gym</a></li>
            <li><a class="waves-effect" href="../../views/commerce/pagina_caminadora.php">Treadmill</a></li>
        </ul>
